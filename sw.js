...
var PRECACHE = [
  ...
  "css/styles.css?v=58",
  "js/app.js?v=58",
  "js/data/card-dossier.js?v=58",
  "js/data/card-images.js?v=58",
  "js/data/card-planche.js?v=58",
  "js/data/card-reference.js?v=58",
  "js/data/cards.js?v=58",
  "js/data/combos.js?v=58",
  "js/data/pair-dictionary.js?v=58",
  "js/data/spreads.js?v=58",
  "js/storage.js?v=58",
  "js/views/associations.js?v=58",
  "js/views/entrainement.js?v=58",
  "js/views/grimoire.js?v=58",
  "js/views/journal.js?v=58",
  "js/views/journalier.js?v=58",
  "js/views/methode.js?v=58",
  "js/views/progression.js?v=58",
  "js/views/tirages.js?v=58",
