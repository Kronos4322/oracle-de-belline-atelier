...
var PRECACHE = [
  ...
  "css/styles.css?v=57",
  "js/app.js?v=57",
  "js/data/card-dossier.js?v=57",
  "js/data/card-images.js?v=57",
  "js/data/card-planche.js?v=57",
  "js/data/card-reference.js?v=57",
  "js/data/cards.js?v=57",
  "js/data/combos.js?v=57",
  "js/data/spreads.js?v=57",
  "js/storage.js?v=57",
  "js/views/associations.js?v=57",
  "js/views/entrainement.js?v=57",
  "js/views/grimoire.js?v=57",
  "js/views/journal.js?v=57",
  "js/views/journalier.js?v=57",
  "js/views/methode.js?v=57",
  "js/views/progression.js?v=57",
  "js/views/tirages.js?v=57",
