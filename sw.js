...
var PRECACHE = [
  ...
  "css/styles.css?v=48",
  "js/app.js?v=48",
  "js/data/card-dossier.js?v=48",
  "js/data/card-images.js?v=48",
  "js/data/card-planche.js?v=48",
  "js/data/card-reference.js?v=48",
  "js/data/cards.js?v=48",
  "js/data/combos.js?v=48",
  "js/data/spreads.js?v=48",
  "js/storage.js?v=48",
  "js/views/associations.js?v=48",
  "js/views/entrainement.js?v=48",
  "js/views/grimoire.js?v=48",
  "js/views/journal.js?v=48",
  "js/views/journalier.js?v=48",
  "js/views/methode.js?v=48",
  "js/views/progression.js?v=48",
  "js/views/tirages.js?v=48",
