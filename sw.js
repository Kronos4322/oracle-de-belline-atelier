...
var PRECACHE = [
  ...
  "css/styles.css?v=42",
  "js/app.js?v=42",
  "js/data/card-dossier.js?v=42",
  "js/data/card-images.js?v=42",
  "js/data/card-planche.js?v=42",
  "js/data/card-reference.js?v=42",
  "js/data/cards.js?v=42",
  "js/data/combos.js?v=42",
  "js/data/spreads.js?v=42",
  "js/storage.js?v=42",
  "js/views/associations.js?v=42",
  "js/views/entrainement.js?v=42",
  "js/views/grimoire.js?v=42",
  "js/views/journal.js?v=42",
  "js/views/journalier.js?v=42",
  "js/views/methode.js?v=42",
  "js/views/progression.js?v=42",
  "js/views/tirages.js?v=42",
