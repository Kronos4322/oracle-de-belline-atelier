...
var PRECACHE = [
  ...
  "css/styles.css?v=56",
  "js/app.js?v=56",
  "js/data/card-dossier.js?v=56",
  "js/data/card-images.js?v=56",
  "js/data/card-planche.js?v=56",
  "js/data/card-reference.js?v=56",
  "js/data/cards.js?v=56",
  "js/data/combos.js?v=56",
  "js/data/spreads.js?v=56",
  "js/storage.js?v=56",
  "js/views/associations.js?v=56",
  "js/views/entrainement.js?v=56",
  "js/views/grimoire.js?v=56",
  "js/views/journal.js?v=56",
  "js/views/journalier.js?v=56",
  "js/views/methode.js?v=56",
  "js/views/progression.js?v=56",
  "js/views/tirages.js?v=56",
