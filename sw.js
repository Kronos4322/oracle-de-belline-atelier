...
var PRECACHE = [
  ...
  "css/styles.css?v=61",
  "js/app.js?v=61",
  "js/data/card-dossier.js?v=61",
  "js/data/card-images.js?v=61",
  "js/data/card-planche.js?v=61",
  "js/data/card-reference.js?v=61",
  "js/data/cards.js?v=61",
  "js/data/combos.js?v=61",
  "js/data/pair-dictionary.js?v=61",
  "js/data/planet-dossier.js?v=61",
  "js/data/spreads.js?v=61",
  "js/storage.js?v=61",
  "js/views/associations.js?v=61",
  "js/views/astrologie.js?v=61",
  "js/views/entrainement.js?v=61",
  "js/views/grimoire.js?v=61",
  "js/views/journal.js?v=61",
  "js/views/journalier.js?v=61",
  "js/views/methode.js?v=61",
  "js/views/progression.js?v=61",
  "js/views/tirages.js?v=61",
