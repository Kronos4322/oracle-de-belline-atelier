...
var PRECACHE = [
  ...
  "css/styles.css?v=62",
  "js/app.js?v=62",
  "js/data/card-dossier.js?v=62",
  "js/data/card-images.js?v=62",
  "js/data/card-planche.js?v=62",
  "js/data/card-reference.js?v=62",
  "js/data/cards.js?v=62",
  "js/data/combos.js?v=62",
  "js/data/pair-dictionary.js?v=62",
  "js/data/planet-dossier.js?v=62",
  "js/data/spreads.js?v=62",
  "js/storage.js?v=62",
  "js/views/associations.js?v=62",
  "js/views/astrologie.js?v=62",
  "js/views/entrainement.js?v=62",
  "js/views/grimoire.js?v=62",
  "js/views/journal.js?v=62",
  "js/views/journalier.js?v=62",
  "js/views/methode.js?v=62",
  "js/views/progression.js?v=62",
  "js/views/tirages.js?v=62",
