...
var PRECACHE = [
  ...
  "css/styles.css?v=45",
  "js/app.js?v=45",
  "js/data/card-dossier.js?v=45",
  "js/data/card-images.js?v=45",
  "js/data/card-planche.js?v=45",
  "js/data/card-reference.js?v=45",
  "js/data/cards.js?v=45",
  "js/data/combos.js?v=45",
  "js/data/spreads.js?v=45",
  "js/storage.js?v=45",
  "js/views/associations.js?v=45",
  "js/views/entrainement.js?v=45",
  "js/views/grimoire.js?v=45",
  "js/views/journal.js?v=45",
  "js/views/journalier.js?v=45",
  "js/views/methode.js?v=45",
  "js/views/progression.js?v=45",
  "js/views/tirages.js?v=45",
