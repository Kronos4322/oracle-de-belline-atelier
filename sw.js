...
var PRECACHE = [
  ...
  "css/styles.css?v=47",
  "js/app.js?v=47",
  "js/data/card-dossier.js?v=47",
  "js/data/card-images.js?v=47",
  "js/data/card-planche.js?v=47",
  "js/data/card-reference.js?v=47",
  "js/data/cards.js?v=47",
  "js/data/combos.js?v=47",
  "js/data/spreads.js?v=47",
  "js/storage.js?v=47",
  "js/views/associations.js?v=47",
  "js/views/entrainement.js?v=47",
  "js/views/grimoire.js?v=47",
  "js/views/journal.js?v=47",
  "js/views/journalier.js?v=47",
  "js/views/methode.js?v=47",
  "js/views/progression.js?v=47",
  "js/views/tirages.js?v=47",
