...
var PRECACHE = [
  ...
  "css/styles.css?v=46",
  "js/app.js?v=46",
  "js/data/card-dossier.js?v=46",
  "js/data/card-images.js?v=46",
  "js/data/card-planche.js?v=46",
  "js/data/card-reference.js?v=46",
  "js/data/cards.js?v=46",
  "js/data/combos.js?v=46",
  "js/data/spreads.js?v=46",
  "js/storage.js?v=46",
  "js/views/associations.js?v=46",
  "js/views/entrainement.js?v=46",
  "js/views/grimoire.js?v=46",
  "js/views/journal.js?v=46",
  "js/views/journalier.js?v=46",
  "js/views/methode.js?v=46",
  "js/views/progression.js?v=46",
  "js/views/tirages.js?v=46",
