...
var PRECACHE = [
  ...
  "css/styles.css?v=59",
  "js/app.js?v=59",
  "js/data/card-dossier.js?v=59",
  "js/data/card-images.js?v=59",
  "js/data/card-planche.js?v=59",
  "js/data/card-reference.js?v=59",
  "js/data/cards.js?v=59",
  "js/data/combos.js?v=59",
  "js/data/pair-dictionary.js?v=59",
  "js/data/planet-dossier.js?v=59",
  "js/data/spreads.js?v=59",
  "js/storage.js?v=59",
  "js/views/associations.js?v=59",
  "js/views/astrologie.js?v=59",
  "js/views/entrainement.js?v=59",
  "js/views/grimoire.js?v=59",
  "js/views/journal.js?v=59",
  "js/views/journalier.js?v=59",
  "js/views/methode.js?v=59",
  "js/views/progression.js?v=59",
  "js/views/tirages.js?v=59",
