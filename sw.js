...
var PRECACHE = [
  ...
  "css/styles.css?v=54",
  "js/app.js?v=54",
  "js/data/card-dossier.js?v=54",
  "js/data/card-images.js?v=54",
  "js/data/card-planche.js?v=54",
  "js/data/card-reference.js?v=54",
  "js/data/cards.js?v=54",
  "js/data/combos.js?v=54",
  "js/data/spreads.js?v=54",
  "js/storage.js?v=54",
  "js/views/associations.js?v=54",
  "js/views/entrainement.js?v=54",
  "js/views/grimoire.js?v=54",
  "js/views/journal.js?v=54",
  "js/views/journalier.js?v=54",
  "js/views/methode.js?v=54",
  "js/views/progression.js?v=54",
  "js/views/tirages.js?v=54",
