...
var PRECACHE = [
  ...
  "css/styles.css?v=53",
  "js/app.js?v=53",
  "js/data/card-dossier.js?v=53",
  "js/data/card-images.js?v=53",
  "js/data/card-planche.js?v=53",
  "js/data/card-reference.js?v=53",
  "js/data/cards.js?v=53",
  "js/data/combos.js?v=53",
  "js/data/spreads.js?v=53",
  "js/storage.js?v=53",
  "js/views/associations.js?v=53",
  "js/views/entrainement.js?v=53",
  "js/views/grimoire.js?v=53",
  "js/views/journal.js?v=53",
  "js/views/journalier.js?v=53",
  "js/views/methode.js?v=53",
  "js/views/progression.js?v=53",
  "js/views/tirages.js?v=53",
