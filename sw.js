...
var PRECACHE = [
  ...
  "css/styles.css?v=60",
  "js/app.js?v=60",
  "js/data/card-dossier.js?v=60",
  "js/data/card-images.js?v=60",
  "js/data/card-planche.js?v=60",
  "js/data/card-reference.js?v=60",
  "js/data/cards.js?v=60",
  "js/data/combos.js?v=60",
  "js/data/pair-dictionary.js?v=60",
  "js/data/planet-dossier.js?v=60",
  "js/data/spreads.js?v=60",
  "js/storage.js?v=60",
  "js/views/associations.js?v=60",
  "js/views/astrologie.js?v=60",
  "js/views/entrainement.js?v=60",
  "js/views/grimoire.js?v=60",
  "js/views/journal.js?v=60",
  "js/views/journalier.js?v=60",
  "js/views/methode.js?v=60",
  "js/views/progression.js?v=60",
  "js/views/tirages.js?v=60",
