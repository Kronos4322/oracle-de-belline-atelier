...
var PRECACHE = [
  ...
  "css/styles.css?v=51",
  "js/app.js?v=51",
  "js/data/card-dossier.js?v=51",
  "js/data/card-images.js?v=51",
  "js/data/card-planche.js?v=51",
  "js/data/card-reference.js?v=51",
  "js/data/cards.js?v=51",
  "js/data/combos.js?v=51",
  "js/data/spreads.js?v=51",
  "js/storage.js?v=51",
  "js/views/associations.js?v=51",
  "js/views/entrainement.js?v=51",
  "js/views/grimoire.js?v=51",
  "js/views/journal.js?v=51",
  "js/views/journalier.js?v=51",
  "js/views/methode.js?v=51",
  "js/views/progression.js?v=51",
  "js/views/tirages.js?v=51",
