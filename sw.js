...
var PRECACHE = [
  ...
  "css/styles.css?v=55",
  "js/app.js?v=55",
  "js/data/card-dossier.js?v=55",
  "js/data/card-images.js?v=55",
  "js/data/card-planche.js?v=55",
  "js/data/card-reference.js?v=55",
  "js/data/cards.js?v=55",
  "js/data/combos.js?v=55",
  "js/data/spreads.js?v=55",
  "js/storage.js?v=55",
  "js/views/associations.js?v=55",
  "js/views/entrainement.js?v=55",
  "js/views/grimoire.js?v=55",
  "js/views/journal.js?v=55",
  "js/views/journalier.js?v=55",
  "js/views/methode.js?v=55",
  "js/views/progression.js?v=55",
  "js/views/tirages.js?v=55",
