...
var PRECACHE = [
  ...
  "css/styles.css?v=44",
  "js/app.js?v=44",
  "js/data/card-dossier.js?v=44",
  "js/data/card-images.js?v=44",
  "js/data/card-planche.js?v=44",
  "js/data/card-reference.js?v=44",
  "js/data/cards.js?v=44",
  "js/data/combos.js?v=44",
  "js/data/spreads.js?v=44",
  "js/storage.js?v=44",
  "js/views/associations.js?v=44",
  "js/views/entrainement.js?v=44",
  "js/views/grimoire.js?v=44",
  "js/views/journal.js?v=44",
  "js/views/journalier.js?v=44",
  "js/views/methode.js?v=44",
  "js/views/progression.js?v=44",
  "js/views/tirages.js?v=44",
