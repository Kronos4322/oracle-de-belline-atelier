...
var PRECACHE = [
  ...
  "css/styles.css?v=50",
  "js/app.js?v=50",
  "js/data/card-dossier.js?v=50",
  "js/data/card-images.js?v=50",
  "js/data/card-planche.js?v=50",
  "js/data/card-reference.js?v=50",
  "js/data/cards.js?v=50",
  "js/data/combos.js?v=50",
  "js/data/spreads.js?v=50",
  "js/storage.js?v=50",
  "js/views/associations.js?v=50",
  "js/views/entrainement.js?v=50",
  "js/views/grimoire.js?v=50",
  "js/views/journal.js?v=50",
  "js/views/journalier.js?v=50",
  "js/views/methode.js?v=50",
  "js/views/progression.js?v=50",
  "js/views/tirages.js?v=50",
